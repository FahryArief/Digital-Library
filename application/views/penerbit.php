...
<div class="row">
    <div class="col-md-12">
        <button type="button" data-bs-target=".Tambah" data-bs-toggle="modal"
            ...
            <i class="bx bx-plus font-size-16 align-middle me-2"></i> Tambah Penerbit
        </button>
    </div>
</div>
                ...
                <div class="modal-body">
                    <form method="POST" action=" <?= base_url()?>penerbit/simpan">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="nama_penerbit" class="form-control" id="floatingnameInput"
                                placeholder="Enter Name">
                            <label for="floatingnameInput">Nama Penerbit</label>
                        </div>
...
?>
                        ...
                        <div>
                            <!-- center modal -->
                            <div class="modal fade Edit<?= $row->id_penerbit ?>" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action=" <?= base_url()?>penerbit/update">
                                                <div class="mb-3">
                                                    <input type="textz" name="id_penerbit" class="form-control"
                                                        id="floatingidaInput" hidden value="<?= $row->id_penerbit ?>"
                                                        placeholder="">
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input type="text" value="<?= $row->nama_penerbit ?>"
                                                        name="nama_penerbit" class="form-control" id="floatingnameInput"
                                                        placeholder="Enter Name">
                                                    <label for="floatingnameInput">Nama Penerbit</label>
                                                </div>
                                                <div class="d-flex justify-content-between p-2">
