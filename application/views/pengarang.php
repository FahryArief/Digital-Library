...
<div class="row">
    <div class="col-md-12">
        <button type="button" data-bs-target=".Tambah" data-bs-toggle="modal"
            ...
            <i class="bx bx-plus font-size-16 align-middle me-2"></i> Tambah Pengarang
        </button>
    </div>
</div>
                ...
                <div class="modal-body">
                    <form method="POST" action=" <?= base_url()?>pengarang/simpan">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="nama_pengarang" class="form-control" id="floatingnameInput"
            ...
            <div class="card-body">
                <table id="datatable" class="table table-striped dt-responsive  w-100">
                    ...
                    <tbody>
                        ...
                        <div>
                            <!-- center modal -->
                            <div class="modal fade Edit<?= $row->id_pengarang ?>" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form method="POST" action=" <?= base_url()?>pengarang/update">
                                                <div class="mb-3">
                                                    <input type="text" name="id_pengarang" class="form-control"
                                                        id="floatingidaInput" hidden value="<?= $row->id_pengarang ?>"
                                                        placeholder="">
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input type="text" value="<?= $row->nama_pengarang ?>"
                                                        name="nama_pengarang" class="form-control"
