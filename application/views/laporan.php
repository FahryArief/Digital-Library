    ...
    <div class="box-header">
        <form method="post" action="<?= base_url()?>laporan">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="<?= base_url()?>laporan" class="btn btn-warning btn-block btn-refresh"><i
                            class="bx bx-rotate-right"></i> Refresh</a>
                </div>

                <div class="col-md-2">
                    <a href="<?= base_url()?>laporan/pdf_laporan" class="btn btn-danger btn-block btn-pdf"
                        target="_blank"> <i class="fa fa-file-pdf-o"></i> View PDF</a>
                </div>
            </div>
